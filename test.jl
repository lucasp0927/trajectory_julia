...
#    Fields.initialize((100,100),(100,100))
    ...
    sf1 = Fields.zero(ScalarField{Float64,2},(1001,1001),(0,0),(1000,1000))
    sf2 = Fields.zero(ScalarField{Float64,2},(101,101),(299,299),(300,300))
    #########
    println("aligning")    
    sfn = Fields.ScalarFieldNode{2}([sf1,sf2])
    ...
    #########
    println("aligning")
    sfn = Fields.ScalarFieldNode{3}([sf1,sf2])
    println("geometry of sf1")
    println(Fields.geometry(sf1))
    println("geometry of sf2")
    println(Fields.geometry(sf2))    
